...
export default class SettingsAuthors extends Component {
    state = {
        form: defaultForm,
        items: [],
    ...
    handleDeleteItem = (item) => {
        this.dialogModal.open({
            ...
            this.setState({inProgress: true}, () => {
                AuthorService.delete(item.id).then(() => {
    ...
    handleSubmit = () => {
        ...
        this.setState({modalInProgress: true}, () => {
            AuthorService[method](requestForm, form.id).then(response => {
